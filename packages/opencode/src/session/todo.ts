...
export const defaultLayer = layer.pipe(Layer.provide(EventV2Bridge.defaultLayer), Layer.provide(DatabaseDefaultLayer))

export const node = LayerNode.make(layer, [EventV2Bridge.node, DatabaseNode])
