...
export function ModelSelectorPopover(props: {
  ...
  return (
    ...
    >
      ...
      <Kobalte.Portal>
        <Kobalte.Content
          class="w-[600px] h-[400px] flex flex-col p-2 rounded-md border border-border-base bg-surface-raised-stronger-non-alpha shadow-md z-50 outline-none overflow-hidden"
